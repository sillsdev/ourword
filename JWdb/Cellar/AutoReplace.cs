...
namespace JWdb
{
	...
	public class JTreeNode
	{
		...
		public void Add(string sSource, string sResult)
		{
			...
			if (iPos == m_rgLetter.Length)
			{
				...
				JTreeNode[] rgLower = new JTreeNode[ m_rgLetter.Length + 1];
				...
				rgLower [iPos] = new JTreeNode(this);
		...
		#region Constructor()
		public JTreeNode(JTreeNode parent)
		{
			m_rgLetter = new char[0];
			m_rgLower  = new JTreeNode[0];
			m_parent   = parent;
		}
		#endregion
	...
	public class TreeRoot : JTreeNode
	{
