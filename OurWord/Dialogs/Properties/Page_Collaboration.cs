    ...
    public partial class Page_Collaboration : DlgPropertySheet
    {
        ...
        void BuildLiterateSettings()
        {
            ...
            LS.AddInformation("co100", StyleSheet.LiterateHeading,
                "A. Introduction");
            LS.AddInformation("co110", StyleSheet.LiterateParagraph,
            ...
            LS.AddInformation("co120", StyleSheet.LiterateParagraph,
            ...
            LS.AddInformation("co130", StyleSheet.LiterateParagraph,
            ...
            if (!Repository.CheckMercurialIsInstalled())
            {
                ...
                LS.AddInformation("co210", StyleSheet.LiterateList,
                    "Linux - http://www.selenic.com/mercurial/wiki/index.cgi/BinaryPackages");
                LS.AddInformation("co220", StyleSheet.LiterateList,
                    "Windows - http://sourceforge.net/project/showfiles.php?group_id=199155");
            }

            // Central Repository
            LS.AddInformation("co400", StyleSheet.LiterateHeading,
                "C. Central Repository");
            LS.AddInformation("co410", StyleSheet.LiterateParagraph,
                ...
                "to them.");
            LS.AddInformation("co420", StyleSheet.LiterateParagraph,
            ...
            LS.AddInformation("co430", StyleSheet.LiterateParagraph,
