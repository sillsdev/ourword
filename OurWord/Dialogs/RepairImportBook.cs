...
namespace OurWord.Dialogs
{
	...
	public class DialogRepairImportBook : System.Windows.Forms.Form
	{
        ...
        // Scaffolding -----------------------------------------------------------------------
        #region Constructor(DBook, eBookReadException)
        public DialogRepairImportBook(DBook _book, eBookReadException _bre)
		{
            ...
            m_sPathName = _book.AbsolutePathName;
	...
	public class RepairImportBookStructure : DialogRepairImportBook
	{
		...
		public RepairImportBookStructure(DBook _FrontBook, DBook _ImportBook, 
			eBookReadException _bre)
			: base(_ImportBook, _bre)
		{
            ...
            m_sFrontPathName = _FrontBook.AbsolutePathName;
	...
	public class eBookReadException : Exception
	{
		...
		// Scaffolding -----------------------------------------------------------------------
		#region Constructor(BookReadMsg.ID, _LineNo)
		...
		#endregion
		#region Constructor(string _sMessage, int _FrontLineNo, int _LineNo)
