...
namespace OurWord.DataModel
{
	...
	public class Test_DSection : Test
	{
			...
			: base("DSection")
		{
			...
			AddTest( new IndividualTest( TestIO_4 ),   "IO Section #4" );
...
//			EnableTracing = true;
		...
		#endregion
		#region TestIO_4
		public void TestIO_4()
		{
//			EnableTracing = true;

			// Do the IO and section comparision
			TestIO_Engine(m_SectionTest4, false);
		}
		#endregion		
		#region TestIO_7
...
//			EnableTracing = true;
    ...
    #region NUnit Test_DSectionIO
    [TestFixture] public class Test_DSectionIO
    {
        // Helper Methods --------------------------------------------------------------------
