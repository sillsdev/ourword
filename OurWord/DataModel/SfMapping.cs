...
namespace OurWord
{
	public class DSFMapping : JObject
	{
		...
		private string m_sMkrFileId = "id";
		#endregion
		...
		public DTeamSettings TeamSettings
		{
			get
			{
				return (DTeamSettings)Owner;
			}
		}
		#endregion
		#region Attr{g}: JStyleSheet StyleSheet - returns the stylesheet we are mapping
		JStyleSheet StyleSheet
		{
			get
			{
