...
namespace JWTools
{
	...
	#endregion
    #region CLASS: BoolPropertySpec : PropertySpec
    ...
    // Converters & Editors ------------------------------------------------------------------
    #region CLASS PropertyEnumStringConverter : StringConverter
    ...
    #endregion
    #region CLASS: ColorConverter : StringConverter
    ...
    #endregion
    #region CLASS: ColorTypeEditor : UITypeEditor
    ...
    #endregion
    #region CLASS: FontNameConverter : StringConverter
    ...
    #region CLASS: PropertyBagTypeConverter : TypeConverter   (JSW)
